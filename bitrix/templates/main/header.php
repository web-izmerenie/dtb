    ...
    <?$APPLICATION->ShowPanel();?>
        <div class="wrapper">
            <header class="header">
                ...
                <?$APPLICATION->IncludeComponent( "bitrix:menu", "main-menu", Array( "ROOT_MENU_TYPE" => "top", "MENU_CACHE_TYPE" => "A", "MENU_CACHE_TIME" => "3600", "MENU_CACHE_USE_GROUPS" => "Y", "MENU_CACHE_GET_VARS" => "", "MAX_LEVEL" => "1", "CHILD_MENU_TYPE" => "", "USE_EXT" => "N", "DELAY" => "N", "ALLOW_MULTI_SELECT" => "N" ) );?>
            </header>
            <!-- .header-->
            <main class="content">
