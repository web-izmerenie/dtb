...
$MESS['HIDE_FIELD_NAME_TIP']            = 'Все названия полей в шаблоне формы будут спрятаны';
...
$MESS['INSTALL_IBLOCK_TIP']             = 'Будут установлены необходимые для работы модуля "Тип инфоблока" и "Инфоблок".<br> Для других инфоблоков обязательно необходимо наличие свойства типа "строка" с кодом "TICKET_ID".<br>После создания инфоблока, если он не появился в выпадающем списке, нажмите напротив "Тип инфоблока" кнопку "ОК".<br>После создания инфоблоков рекомендую убрать галку с этой опции, чтобы при каждом открытии параметров не происходил поиск инфоблока.';
$MESS['UUID_LENGTH_TIP']                = 'Рекомендуется 10, чем меньше, тем больше вероятность совпадений. Максимум 32.';
$MESS['DISABLE_SEND_MAIL_TIP']          = 'Можете добавлять информацию в инфоблок без отправки уведомлений на e-mail';