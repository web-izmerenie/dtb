...
$MESS["INSTALL_IBLOCK"]          = "Создать инфоблок и тип инфоблока";
$MESS['IT_RU_NAME']              = "Тюнинг-Софт";
$MESS['IT_RU_SECTION_NAME']      = "Разделы";
$MESS['IT_RU_ELEMENT_NAME']      = "Элементы";
$MESS['IT_EN_NAME']              = "Tuning-Soft";
$MESS['IT_EN_SECTION_NAME']      = "Sections";
$MESS['IT_EN_ELEMENT_NAME']      = "Elements";
$MESS['IT_CREATE_SUCCESS']       = 'Тип инфоблока "Тюнинг-Софт" успешно создан.';
$MESS['IT_FOUND']                = 'Найден тип инфоблока "Тюнинг-Софт"';
$MESS['IBLOCK_NAME']             = 'Статистика формы обратной связи';
$MESS['IBLOCK_CREATE_SUCCESS']   = 'Инфоблок "Статистика формы обратной связи" успешно создан.';
$MESS['PROP_NAME_TICKET_ID']     = '№ обращения';
$MESS['PROP_NAME_FILES']         = 'Файлы';
$MESS['ALL_PROP_CREATE_SUCCESS'] = 'Все свойства для инфоблока были успешно добавлены, инфоблок готов к работе.';
$MESS['ALL_PROP_CREATE_ERROR']   = 'Внимание! При добавлении свойств возникли ошибки, запись в инфоблок под вопросом.';
$MESS['IBLOCK_FOUND']            = 'Найден инфоблок "Статистика формы обратной связи", инфоблок готов к работе.';
...
$MESS['MFP_AUTHOR_WORK_CITY']       = 'Город работы';
...
$MESS['MFP_USER_FIELDS_TITLE']      = 'Собственные названия полей формы';
...
$MESS['FORM_SUBMIT_ID']             = 'ID для кнопки Отправить';
...
$MESS['MFP_OK_TEXT']                = 'Спасибо, ваше обращение #TICKET_ID# принято.';
...
$MESS['CUSTOM_FIELDS_VALUE_0']      = 'Ваше имя@input@text@required';
$MESS['CUSTOM_FIELDS_VALUE_1']      = 'Ваш e-mail@input@email@required';
$MESS['CUSTOM_FIELDS_VALUE_2']      = 'Текстовое поле@input@text@required';
$MESS['CUSTOM_FIELDS_VALUE_3']      = 'Текстовое поле@input@text@required@value=Значение поля по умолчанию';
$MESS['CUSTOM_FIELDS_VALUE_4']      = 'Дата@input@date@required';
$MESS['CUSTOM_FIELDS_VALUE_4_1']    = 'Интервал дат@input@date@required@size=2';
$MESS['CUSTOM_FIELDS_VALUE_4_2']    = 'Дата и время@input@datetime@required';
$MESS['CUSTOM_FIELDS_VALUE_6']      = 'Список опций@select@values=Опция 1#Опция 2#Опция 3';
$MESS['CUSTOM_FIELDS_VALUE_7']      = 'Группа опций@select@multiple@size=5@required@values=Группа 1##Опция 1#Опция 2#Опция 3##Группа 2##Опция 1#Опция 2#Опция 3';
$MESS['CUSTOM_FIELDS_VALUE_8']      = 'Флажки@input@checkbox@required@values=Значение 1#Значение 2#Значение 3';
$MESS['CUSTOM_FIELDS_VALUE_9']      = 'Переключатели@input@radio@required@values=Значение 1#Значение 2#Значение 3';
$MESS['CUSTOM_FIELDS_VALUE_10']     = 'Текстовая область@textarea@required';
$MESS['CUSTOM_FIELDS_VALUE_11']     = 'Купон на скидку@input@coupon@required@button_value=Получить купон на скидку';
$MESS['CUSTOM_FIELDS_VALUE_12']     = 'Скрытое поле@input@hidden@value=Значение поля по умолчанию';
$MESS['CUSTOM_FIELDS_TITLE']        = '<h3>Разделитель полей <b>поддерживает html-теги</b></h3>';
...
//GROUP_UUID_SETTINGS
$MESS['UUID_SETTINGS']              = 'Настройки генератора уникального ID';
$MESS['UUID_LENGTH']                = 'Длина ID';
$MESS['UUID_PREFIX']                = 'Префикс ID';
