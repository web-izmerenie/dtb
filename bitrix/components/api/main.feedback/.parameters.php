	...
	'PARAMETERS' => array(
		...
		"CUSTOM_FIELDS"               => Array(
			...
			"DEFAULT"  => Array(
				...
				2 => GetMessage('CUSTOM_FIELDS_TITLE'),
				3 => GetMessage('CUSTOM_FIELDS_VALUE_2'),
				4 => GetMessage('CUSTOM_FIELDS_VALUE_3'),
				5 => GetMessage('CUSTOM_FIELDS_VALUE_4'),
				6 => GetMessage('CUSTOM_FIELDS_VALUE_4_1'),
				7 => GetMessage('CUSTOM_FIELDS_VALUE_4_2'),
				8 => GetMessage('CUSTOM_FIELDS_VALUE_6'),
				9 => GetMessage('CUSTOM_FIELDS_VALUE_7'),
				10 => GetMessage('CUSTOM_FIELDS_VALUE_8'),
				11 => GetMessage('CUSTOM_FIELDS_VALUE_9'),
				12 => GetMessage('CUSTOM_FIELDS_VALUE_10'),
				13 => GetMessage('CUSTOM_FIELDS_VALUE_11'),
				14 => GetMessage('CUSTOM_FIELDS_VALUE_12'),
			),
		),
		'BRANCH_ACTIVE'               => Array(
